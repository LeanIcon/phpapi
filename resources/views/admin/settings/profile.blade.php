                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 370.8px;">
                                        <div class="slimscroll education-activity" style="overflow: hidden; width: auto; height: 370.8px;">
                                            <div class="activity">
                                        ...
                                        <div class="slimScrollBar" style="background: rgb(224, 229, 241); width: 7px; position: absolute; top: 0px; opacity: 1; display: block; border-radius: 7px; z-index: 99; right: 1px;"></div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8 align-self-center">
                                            <p class="skill-detail">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words.
                                            </p>
                                        </div>
                                    </div>
                ...
                <div class="tab-pane fade" id="portfolio_detail">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row container-grid nf-col-3  projects-wrapper" style="position: relative; height: 0px;">
                                        <div class="col-lg-4 col-md-6 p-0 nf-item branding design coffee spacing" style="position: absolute; left: 0px;">
                                            <div class="item-box">
                                        ...
                                        <div class="col-lg-4 col-md-6 p-0 nf-item photo spacing" style="position: absolute; left: 0px;">
                                            <div class="item-box">
                                        ...
                                        <div class="col-lg-4 col-md-6 p-0 nf-item branding coffee spacing" style="position: absolute; left: 0px;">
                                            <div class="item-box">
                                        ...
                                        <div class="col-lg-4 col-md-6 p-0 nf-item branding design spacing" style="position: absolute; left: 0px;">
                                            <div class="item-box">
                        ...
                        <div class="col-lg-4">
                            <div class="card ">
                                <div class="card-body">
                                    ...
                                    <div id="carouselExampleFade2" class="carousel slide pointer-event" data-ride="carousel">
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item active">
                                                <div class="text-center">
                                                    <p class="text-muted px-4">
                                                        Where does it come from? Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years popular belief,old.
                                                    </p>
                                                    <div class="">
                                ...
                                <div class="card-body">
                                    <form method="post" class="card-box">
                                        <div class="dropify-wrapper has-preview">
                                            ...
                                            <div class="dropify-preview" style="display: block;"><span class="dropify-render"><img src="../assets/images/users/user-4.jpg"></span>
                                                <div class="dropify-infos">
                                                    <div class="dropify-infos-inner">
                                                        <p class="dropify-filename"><span class="file-icon"></span> <span class="dropify-filename-inner">user-4.jpg</span></p>

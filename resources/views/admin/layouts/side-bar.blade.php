                    ...
                    <div class="menu-body slimscroll">
                        <div id="MetricaAnalytic" class="main-icon-menu-pane">
                            ...
                            <ul class="nav">
                                ...
                                <li class="nav-item"><a class="nav-link" href="#"><i class="dripicons-user-group"></i>Customers</a></li>
                                <li class="nav-item"><a class="nav-link" href="#"><i class="dripicons-document"></i>Reports</a></li> 
                            </ul>
                        </div><!-- end Analytic -->
                        
                        <div id="MetricaOthers" class="main-icon-menu-pane">
                            <div class="title-box">
                                <h6 class="menu-title">Sections</h6>      
                            </div>
                            <ul class="nav metismenu" id="main_menu_side_nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#"><i class="dripicons-view-list-large"></i><span class="w-100">Posts</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                                    <ul class="nav-second-level" aria-expanded="false">

        ...
        <div class="card">
            <div class="card-body order-list">
              <!--  <button type="button" class="btn btn-primary btn-sm px-4 mt-0 mb-3" data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg2">
                ...
                <h4 class="header-title mt-0 mb-3"><span class="badge badge-danger badge-pill noti-icon-badge"> Orders</span> Purchase Invoice</h4>
                <div class="row">
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="{{route('wholesaler.orderinvoicedetails')}}" class="d-inline-block align-middle mb-0 product-name">002</a>                                 </td>

                                </td>
                                <td>
                                    <a href="{{route('wholesaler.orderinvoicedetails')}}" class="d-inline-block align-middle mb-0 product-name">Darko Oscar</a> 

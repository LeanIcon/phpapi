                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" value="{{$postTown->name}}"id="Name" readonly required="">
                        </div>
                    </div>
                    <!--<div class="col-md-6">
                        <div class="form-group">
                            <label for="status-select" class="mr-2">Status</label>
                            <input type="text" class="form-control" name="name" value="{{$postTown->status}}"id="Name" readonly required="">

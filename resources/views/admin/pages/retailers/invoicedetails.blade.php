                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="">
                                                    ...
                                                    <h6><b>Order ID :</b> Inv-00{{$purchaseOrder->purchase_order_id}} </h6>
                                                </div>
                                            </div><!--end col-->
                                            <div class="col-md-3">
                                                <div class="float-left">
                                                    <address class="font-13"><strong class="font-14">Received from :</strong>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 align-self-end">
                                                <div class="w-25 float-right"><strong class="font-14">Status :</strong> Inovoiced

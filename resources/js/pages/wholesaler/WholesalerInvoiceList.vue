      ...
      <div class="table-responsive mt-3">
        ...
        <table class="table table-centered dt-responsive nowrap no-footer" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            ...
            <tbody>
                ...
                <td>
                    <span class="badge" :class="{'badge-info' : order.status == 'pending', 'badge-success' : order.status == 'processed'}" >{{order.status}}</span>
                </td>
                <td>
                    <vs-button
                        size="small"
                        border
                        @click="viewDetails(order.id, order.total, order.reference)"
                    >
                    View Items
                </vs-button>
                </td>

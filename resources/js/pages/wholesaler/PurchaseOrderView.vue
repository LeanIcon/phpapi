          ...
          <div>
            ...
            <ul class="list-unstyled chat-list" data-simplebar="init" style="max-height: 80%;">
                    ...
                    >
                      <div class="simplebar-content" style="padding: 0px;">
                        <li v-for="(item, index) in purchase_orders" :key="index">
                          <!-- <a href="#"></a> -->
                          <router-link
                            :to="{name: 'purchase_order.view', params:{'purchase_order_id': item.id}}"
                          >
                            <div class="media">
              ...
              <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
                <div
                  class="simplebar-scrollbar"
                  style="height: 238px; transform: translate3d(0px, 0px, 0px); display: block;"
                ></div>
              </div>
            </ul>
          </div>
                        ...
                        <div class="col-md-12">
                          <div class="card card-body printableArea">
                            ...
                            <h3>
                              ...
                              <span
                                class="pull-right"
                              >#{{purchase_order.id}}{{formatRef(purchase_order.reference)}}</span>
                            </h3>
                            <hr />
                            <div class="row">
                              <div class="col-md-12">
  ...
  methods: {
    ...
    viewDetails(po_orderId) {
        this.$router.push({
            ...
            params: { purchase_order_id: po_orderId },
        });
    },
    },
    computed: {

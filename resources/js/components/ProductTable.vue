        ...
        <table class="table table-centered dt-responsive nowrap no-footer" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            ...
            <tbody>
                <tr v-for="(product, index) in products.data" :key="index">
                    ...
                    <td> <img style="width:75px;" class="rounded-circle" :src="'/assets/images/product/drugsamp.jpg'" :alt="product.product.name ? product.product.name : product.product.product_name"> {{product.product.name ? product.product.name : product.product.product_name}}</td>

                    <td>{{productDesc(product.product)}}</td>
                    <td>{{product.product.manufacturer.name || product.product.manufacturer}}</td>
